...
<body class="sb-nav-fixed sb-sidenav-toggled">
              ...
              <tbody>
                ...
                if ($result->num_rows > 0) {
                  ...
                  while ($row = $result->fetch_assoc()) {
                    ...
                    $button = $row['confirmed']
                      ? "<button class='btn btn-secondary btn-sm' disabled>Confirmed</button>"
                      : "<button class='btn-confirm btn-sm' onclick='confirmChild({$row['id']}, this)'>Confirm & Notify</button>";
  ...
  <script>
    function confirmChild(id, btn) {
      ...
      axios.post('confirm_enrollment.php', { id: id })
        .then(response => {
    ...
    function exportToExcel() {
      ...
      window.location.href = 'export_daycare.php?school_year=' + encodeURIComponent(year);
    }
