...
<main class="container-fluid px-4">
    ...
    <script>
        ...
        function loadArchivedAccounts(page = 1, search = '') {
            ...
            fetch(`archived_accounts_backend.php?action=list_archived&page=${page}&per_page=10&search=${encodeURIComponent(search)}`)
        ...
        function restoreAccount() {
            ...
            fetch('archived_accounts_backend.php?action=restore', {
                method: 'POST',
                body: formData
            })
            .then(response => response.json())
        ...
        function viewHistory(residentId) {
            ...
            fetch(`archived_accounts_backend.php?action=view_history&resident_id=${residentId}`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
